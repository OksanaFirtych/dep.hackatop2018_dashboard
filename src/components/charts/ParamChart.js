...
import {ComposedChart, ReferenceArea, Line, Area, XAxis, YAxis, CartesianGrid, Tooltip, Legend, Label} from 'recharts';

const CustomizedDot = ({min, max, cx, cy, stroke, payload, value}) => {
	...
	renderChart = () => (
		...
		>
			...
			<Line 
				...
				stroke='#ff7300'
				dot={
					<CustomizedDot min={this.props.minComfortValue} max={this.props.maxComfortValue}/>
				}
			/>
		</ComposedChart>
	);
